...
import 'package:centralized_system_web/controllers/menu_controller.dart';
      ...
      try {
        ...
        // Uri imageUri = await uploadTaskSnapshot.ref.getDownloadURL();
         final refs = FirebaseStorage.instance
            ...
            .child('$_uuid.jpg');
        if (kIsWeb) {
          await refs.putData(webImage);
        } else {
          await refs.putFile(_pickedImage!);
        }
        Uri imageUri =  (await refs.getDownloadURL()) as Uri;
